...
void loop() 
{
	...
	// Uncomment lines corresponding to your MCU as desired

	// ATmega328P, ATmega168
	LowPower.idle(
			SLEEP_8S, ADC_OFF, TIMER2_OFF, TIMER1_OFF, TIMER0_OFF,
	...
	// ATmega2560
	//LowPower.idle(
	//		SLEEP_8S, ADC_OFF, TIMER5_OFF, TIMER4_OFF, TIMER3_OFF,
